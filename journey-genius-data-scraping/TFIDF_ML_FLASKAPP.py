#-----------SUMMARY-------------
#This is a Flask version of TFIDF_ML script
#This Flask app is currently set to run on port 7000
...
@app.route('/api/run_ML_model_recommendations', methods=['GET'])
def recommend():
...
if __name__ == '__main__':
    app.run(host="localhost", port=7000, debug=True) #Runs on port 7000
