...
# with open('journey-genius-data-scraping/shopping_data.csv', mode='a', newline='', encoding='utf-8') as file:
...
csv_exists = os.path.exists('journey-genius-data-scraping/shopping_data.csv')
