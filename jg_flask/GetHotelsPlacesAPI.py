...
def scrape_hotels():
    ...
    ############# I RECOMMEND PUTTING THE RELATIVE PATH IN FOR LOCATING THE CSV (E.G. /JourneyGenius/journey-genius-datascraping/hotel....) - Ethan

    # Check if the CSV file already exists
    

    # csv_exists = os.path.exists('/JourneyGenius/journey-genius-datascraping/hotel_data.csv')
    ...
    return "Hotel data scraped successfully!"
