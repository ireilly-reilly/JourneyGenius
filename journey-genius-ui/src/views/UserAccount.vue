    ...
    <v-container>
        <v-card class="mx-auto pa-5" max-width="500">
            ...
            <v-card-actions class="justify-center">
                <v-btn text @click="editInfo = !editInfo">
                ...
                <v-btn v-if="editInfo" color="deep-purple accent-2" @click="confirmChanges" dark>
                    Confirm Changes
                </v-btn>
                <v-btn v-if="editInfo" color="red" @click="resetPassword" dark>
                    Reset Password
                </v-btn>
            </v-card-actions>
        </v-card>
