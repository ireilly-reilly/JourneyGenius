<template>
    <v-layout align-center justify-center>
        ...
        <v-col cols="12" md="10" lg="8" class="text-center">
          ...
          <h2 class="display-1 font-weight-black mb-2">
            <span class="text-deep-purple-accent-2"> You can now close this page.</span>
          </h2>
  ...
  export default {
    ...
    mounted(){
      ...
      axios.post(`http://localhost:8000/api/auth/verify_email/${token}/${email}`)
        .then(response => {
  ...
  .loading-spinner {
    ...
    text-align: center;
    /* align-items: center; justify-content: center; Remove these */
